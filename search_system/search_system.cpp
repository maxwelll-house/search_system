...
string GenerateText(size_t seed, uint64_t length)
{
...
void TestPerfomance()
{
    const uint64_t DOC_COUNT = 50'000;
    const uint64_t WORDS_COUNT = 100;
    const uint64_t WORD_LENGTH = 100;
    const uint64_t QUERY_COUNT = 50'000;
